...
namespace bankingAPP
{
    internal  abstract class Accounts
    {
        ...
        public virtual double Widraw(int p_widrawamount)
        {
            //common validation, formatting, calculation, excptions goes here in parent class
            if (p_widrawamount < 100)
            {
                //throw an exception
                Console.WriteLine("Please enter value greater than 100");
            }
